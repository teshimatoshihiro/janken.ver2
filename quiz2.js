...
function initw() {
  ...
  haikei.src = "bakachingarough.jpg";
  haikei.src = "saddonly.jpg";

  haikei.src = "kekkangeka_01.jpg";
  haikei.src = "yua.jpg"
  haikei.src = "G's academy shot.jpg";
  // haikei.src = "CUNE.jpg"
  ...
  // 正解とか不正解の音を読込む
  backgroundsound = new Audio('Hope_Springs_Eternal.mp3')
  pingpong = new Audio('きらきら輝く4.mp3');
  boo = new Audio('ショック3.mp3');
  ques = new Audio('和太鼓でドドン.mp3');
...
function chkanser() {
  ...
  if (num[ans] == 1) {
    ...
    marubatu_str = "〇";
    atari++;
    document.body.style.backgroundImage = "url('yua2.jpg')";
    setTimeout(function () {
      document.body.style.backgroundImage = "url('G's academy shot.jpg')";
    }, 1500);
  } else {
    marubatu_str = "×";
    boo.play();
    document.body.style.backgroundImage = "url('saddonly.jpg')";
    setTimeout(function () {
      document.body.style.backgroundImage = "url('G's academy shot.jpg')";
    }, 1500);
  }
